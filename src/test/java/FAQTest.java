...
public class FAQTest extends BaseTest {
    ...
    private static List<Arguments> faqData() {
    ...
    @ParameterizedTest(name = "Вопрос #{0} – ответ: {1}")
    @MethodSource("faqData")
    @DisplayName("Проверка текста в ответах на вопросы FAQ")
    public void checkFAQAnswer(int questionIndex, String expectedAnswer) {
        ...
        Assertions.assertEquals(expectedAnswer, actualAnswer,
                "Текст ответа на вопрос #" + questionIndex + " не совпадает");
    }
}